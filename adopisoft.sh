...
wget -O adopisoft-5.1.2-amd64-node-v16.4.0.deb https://github.com/AdoPiSoft/Releases/releases/download/v5.1.2/adopisoft-5.1.2-08302022-amd64-node-v16.4.0.deb
sudo apt-get install ./adopisoft-5.1.2-amd64-node-v16.4.0.deb
